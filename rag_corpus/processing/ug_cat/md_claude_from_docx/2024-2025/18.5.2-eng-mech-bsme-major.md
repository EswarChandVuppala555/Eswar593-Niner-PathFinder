...
-   May request authorization to enroll in ENGR 1202 via a UCOL advisor or via a request to an advisor in the program of interest, if not in UCOL via a request to meesadvisor@uncc.edu.
