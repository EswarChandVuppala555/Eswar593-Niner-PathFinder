...
The Department of Electrical and Computer Engineering offers a Minor in
Electrical Engineering (ECGR) for non-ECGR majors.
...
The Minor in Electrical Engineering assumes that students have a
background in mathematics and physics equivalent to that covered in the
first two years of the ECGR curriculum, which includes the following
courses:
...
A Minor in Electrical Engineering consists of 18 credit hours and
...
*Select at least two of the following. If all three listed courses are
taken, one of the courses may count toward the elective course
requirement below.*
...
*If only two advanced courses were selected above, select an elective
course from the following. All prerequisites for the selected elective
...
This minor is not available for a student who has a major in either
