...
- May request authorization to enroll in ENGR 1201, ETGR 1201 or ETGR 1101 via a UCOL advisor or via a request to the [College of Engineering Advising Department](https://et.charlotte.edu/current-students/advising), if not in UCOL.
...
- ECGR 4090 - Special Topics in Electrical Engineering (1 to 4) *(requires department approval)*
